        ...
        <div className="grid lg:grid-cols-4 sm:grid-cols-2 gap-x-6 gap-y-12 divide-x divide-gray-300">
          <div className="text-center">
            <svg
              ...
              className="fill-gray-600 w-10 inline-block"
              viewBox="0 0 512 512"
            >
              <path
            ...
            <h3 className="text-3xl font-extrabold text-yellow-500 mt-5">400+</h3>
            <p className="font-semibold mt-3">Total Products</p>
          </div>
          <div className="text-center">
            <svg
              xmlns="http://www.w3.org/2000/svg"
            ...
            <h3 className="text-3xl font-extrabold text-yellow-500 mt-5">450+</h3>
          ...
          <div className="text-center">
            ...
            <h3 className="text-3xl font-extrabold text-yellow-500 mt-5">500+</h3>
          ...
          <div className="text-center">
            ...
            <h3 className="text-3xl font-extrabold text-yellow-500 mt-5">600+</h3>
